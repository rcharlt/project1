/*Rylee Charlton, project 1, task list, 2/3/19 */
package com.company;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (choice != 0) {
            ...
            if (choice == 2) {
                ...
                System.out.println("Enter the task number you want to remove (1st task is 0): ");
                int s1 = input3.nextInt();
                removeTask(list, s1);
            }
    ...
    //remove task method
    public static void removeTask(String[] storage, int s1) {
        for (int i = 0; i < storage.length; i++) {
            storage[s1] = null;
            return;
        }
